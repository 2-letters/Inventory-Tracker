    ...
    public class firebaseTest
    {
        ...
        public List<labItems> GetAllItemsMethod2()
        {
            ...
            foreach (DocumentSnapshot queryResult in querySnapshot)
            {
                ...
                {
                    name = queryResult.GetValue<string>("equipment"),
        ...
        public List<labItems>GetItemsForLabs(string id)
        {
            ...
            foreach (DocumentSnapshot queryResult in equipmentSanpshot)
            {
                ...
                {
                    name = queryResult.GetValue<string>("itemName"),
                    description = queryResult.GetValue<string>("description"),
                    room = queryResult.GetValue<string>("room"),
                    id = queryResult.Id,
        ...
        public void pushNewEquipments(List<labItems>  newEquipment, List<labItems>  editedEquipment)
        {
                ...
                foreach (var item in newEquipment)
            {
                ...
                DocumentReference addedDocRef2 = db.Collection("EquipmentsTestRJ").AddAsync(itemsInDocument).GetAwaiter().GetResult();
