...
new Vue({
    ...
    mounted() {
        ...
        for (i = 0; i < model.IndexList.length; i++) {
            this.index++;
            this.equipment.push(new Equipment(model.IndexList[i].name, model.IndexList[i].description, model.IndexList[i].location, this.index, model.IndexList[i].pictureUrl, model.IndexList[i].quantity, false, model.IndexList[i].id, model.IndexList[i].sub_location, model.IndexList[i].room))
            this.original2.push(new Equipment(model.IndexList[i].name, model.IndexList[i].description, model.IndexList[i].location, this.index, model.IndexList[i].pictureUrl, model.IndexList[i].quantity, false, model.IndexList[i].id, model.IndexList[i].sub_location, model.IndexList[i].room))
    ...
    methods: {
        ...
        save: function () {
            ...
            $.ajax({
                type: 'POST',
                url: '/Home/PushNewInventory',
                data: {
                    newEquipment: this.NewEquipmentToSave,
                    editedEquipment: finishedCheckEdited,
                },
